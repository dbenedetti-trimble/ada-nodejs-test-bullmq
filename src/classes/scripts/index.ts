...
export class Scripts {
  ...
  protected addStandardJob(
    ...
    return (this.jobScripts as any).addStandardJob(
      client,
      job,
      encodedOpts,
      args,
  ...
  protected addDelayedJob(
    ...
    return (this.jobScripts as any).addDelayedJob(
      client,
      job,
      encodedOpts,
      args,
  ...
  protected addPrioritizedJob(
    ...
    return (this.jobScripts as any).addPrioritizedJob(
      client,
      job,
      encodedOpts,
      args,
  ...
  protected addParentJob(
    ...
    return (this.jobScripts as any).addParentJob(
      client,
      job,
      encodedOpts,
      args,
  ...
  protected addStandardJobArgs(
    ...
    return (this.jobScripts as any).addStandardJobArgs(job, encodedOpts, args);
  }
  ...
  protected addDelayedJobArgs(
    ...
    return (this.jobScripts as any).addDelayedJobArgs(job, encodedOpts, args);
  }
  ...
  protected addPrioritizedJobArgs(
    ...
    return (this.jobScripts as any).addPrioritizedJobArgs(
      job,
      encodedOpts,
      args,
    );
  ...
  protected addParentJobArgs(
    ...
    return (this.jobScripts as any).addParentJobArgs(job, encodedOpts, args);
  }
  ...
  protected changePriorityArgs(
    ...
    return (this.jobScripts as any).changePriorityArgs(jobId, priority, lifo);
  }
  ...
  // --- QueueScripts delegation ---

  protected pauseArgs(pause: boolean): (string | number)[] {
    return (this.queueScripts as any).pauseArgs(pause);
  }
  ...
  protected getCountsPerPriorityArgs(
    ...
    return (this.queueScripts as any).getCountsPerPriorityArgs(priorities);
  }
  ...
  protected addRepeatableJobArgs(
    ...
    return (this.schedulerScripts as any).addRepeatableJobArgs(
      customKey,
      nextMillis,
      opts,
      legacyCustomKey,
  ...
  protected moveToFinishedArgs<T = any, R = any, N extends string = string>(
    ...
    return (this.workerScripts as any).moveToFinishedArgs(
      job,
      val,
      propVal,
      shouldRemove,
  ...
  protected moveToCompletedArgs<T = any, R = any, N extends string = string>(
    ...
    return (this.workerScripts as any).moveToCompletedArgs(
      job,
      returnvalue,
      removeOnComplete,
      token,
  ...
  protected moveToFailedArgs<T = any, R = any, N extends string = string>(
    ...
    return (this.workerScripts as any).moveToFailedArgs(
      job,
      failedReason,
      removeOnFailed,
      token,
  ...
  protected moveStalledJobsToWaitArgs(): (string | number)[] {
    return (this.workerScripts as any).moveStalledJobsToWaitArgs();
  }
  ...
  protected moveJobsToWaitArgs(
    ...
    return (this.workerScripts as any).moveJobsToWaitArgs(
      state,
      count,
      timestamp,
    );
